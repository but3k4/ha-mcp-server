...
async def test_get_addon_info(
    ...
    mock_client.get.assert_called_once_with(
        "/api/hassio/addons/core_mosquitto/info"
    )
...
async def test_install_addon(
    ...
    mock_client.post.assert_called_once_with(
        "/api/hassio/addons/core_ssh/install"
    )
...
async def test_update_addon(
    ...
    assert result == "ok"
    mock_client.post.assert_called_once_with(
        "/api/hassio/addons/core_mosquitto/update"
    )
...
async def test_start_addon(
    ...
    assert result == "ok"
    mock_client.post.assert_called_once_with(
        "/api/hassio/addons/core_mosquitto/start"
    )
...
async def test_get_addon_logs(
    ...
    mock_client.get.assert_called_once_with(
        "/api/hassio/addons/core_mosquitto/logs"
    )
...
async def test_list_addon_repositories_empty(
    ...
    """
    list_addon_repositories returns an empty list when no repositories are
    configured.
    """
